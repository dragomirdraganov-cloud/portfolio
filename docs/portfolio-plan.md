# Pauta de desarrollo del portfolio
...
- Revisar ortografia y acentos si decides usar caracteres no ASCII.
- Probar en movil, tablet y escritorio.
- Confirmar que todos los enlaces llevan a destinos reales.
- Verificar contraste de textos e imagenes.
- Optimizar capturas reales para web antes de subirlas.
